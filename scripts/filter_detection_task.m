...
%   2) Navigate to the main folder (filter_detection_task) in matlab, and
%      type filter_detection_task into the matlab terminal.
%   3) Use the supplied instructions files to explain the task requirements
%      to the participant (see filter_detection_task/participant_
...
%      provided de-briefing questionnaire (see filter_detection_task/
...
% (see scripts/filter_detection_task_fix.m) and to run the analysis (see
% scripts/filter_detection_analysis.m) for all subjects.
