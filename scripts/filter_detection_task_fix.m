...
% performing the filter_detection_task, or for combining two files from the
% same participant into one file for analysis.

% To call the function, type filter_detection_task_fix into the matlab
% terminal from the main filter_detection_task folder.
...
function filter_detection_task_fix()
